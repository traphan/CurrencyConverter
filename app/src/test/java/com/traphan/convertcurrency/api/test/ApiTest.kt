package com.traphan.convertcurrency.api.test
    ...
    fun setUp() {
        ...
        try {
            ...
            val currencyApiTestHelper = CurrencyApiTestHelper(
                util,
                "C:/Users/traph/AndroidStudioProjects/CurrencyConverter/app/src/test/java/com/traphan/convertcurrency/api/resources/currency"
            )
