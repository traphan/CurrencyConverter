...
import traphan.ren95.convertcurrency.ui.CurrencyTextWatcher
import kotlinx.android.synthetic.main.currency_card_item.view.*
import traphan.ren95.convertcurrency.R
import traphan.ren95.convertcurrency.ui.util.CurrencyCalculationAdapterDiffUtil
        ...
        internal fun bind(position: Int) {
            ...
            itemView.inputValueCurrency.setOnClickListener {
                ...
                currencyTextWatcher = CurrencyTextWatcher(
                    currencyViewEntities[position], true, itemView.outputValueCurrency, itemView.inputValueCurrency,
            ...
            itemView.outputValueCurrency.setOnClickListener {
                currencyTextWatcher?.clear()
                currencyTextWatcher = CurrencyTextWatcher(
                    currencyViewEntities[position], false, itemView.inputValueCurrency, itemView.outputValueCurrency,
                    this@CurrenciesAdapter
                )
